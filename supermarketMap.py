...
file_name = 'NetworkDistance-supermarket0622 - 0626remove149-only37left-beforeDelete - rankDCG.xlsx'
import pandas as pd
xl_workbook = pd.ExcelFile(file_name)  # Load the excel workbook
df = xl_workbook.parse("Sheet1 (3)")  # Parse the sheet into a dataframe
